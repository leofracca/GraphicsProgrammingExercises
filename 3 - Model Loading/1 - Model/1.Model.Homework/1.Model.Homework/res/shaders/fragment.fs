...
vec3 CalcDirectionalLight(DirectionalLight light, vec3 normal, vec3 viewDir)
{
    ...
    float spec = pow(max(dot(viewDir, reflectDir), 0.0), 32.0/*u_material.shininess*/);
    // Combine results
...
void main()
{
    ...
    // Point Lights (we don't have any in this scene)
    ...
    // Use the following to render the scene without lighting
