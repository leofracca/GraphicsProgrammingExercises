...
const std::string TITLE = "Normal Mapping (Homework)";
...
int main()
{
    ...
    // Load textures
    Texture diffuseMap("res/textures/brickwall.jpg", GL_CLAMP_TO_EDGE);
    Texture normalMap("res/textures/brickwall_normal.jpg", GL_CLAMP_TO_EDGE);
