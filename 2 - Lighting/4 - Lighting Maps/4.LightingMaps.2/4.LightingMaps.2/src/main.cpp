...
* colors instead of black and white and see that the result doesn't look too realistic
*/
...
const std::string TITLE = "LightingMaps2";
...
int main()
{
    ...
    Texture specularMap("res/textures/lighting_maps_specular_color.png", GL_CLAMP_TO_EDGE, true);
    lightingShader.use();
