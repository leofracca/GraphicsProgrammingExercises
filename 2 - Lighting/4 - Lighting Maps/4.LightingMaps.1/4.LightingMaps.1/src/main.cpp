/*
* Try inverting the color values of the specular map in the fragment shader
* so that the wood shows specular highlights and the steel borders do not
* (note that due to the cracks in the steel border the borders still show
* some specular highlight, although with less intensity)
*/
...
const std::string TITLE = "LightingMaps1";
