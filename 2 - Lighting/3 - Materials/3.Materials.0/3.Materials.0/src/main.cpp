/*
* Change the light’s colors over time by changing the light’s
* ambient and diffuse colors via sin and glfwGetTime.
* Also change the light cube according to the object color!
*/
...
const std::string TITLE = "Materials0 (Exercise 4)";
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("u_material.ambient", 1.0f, 0.5f, 0.31f);
        lightingShader.setVec3("u_material.diffuse", 1.0f, 0.5f, 0.31f);
        lightingShader.setVec3("u_material.specular", 0.5f, 0.5f, 0.5f);
        ...
        lightingShader.setVec3("u_light.diffuse", diffuseColor);
        lightingShader.setVec3("u_light.specular", 1.0f, 1.0f, 1.0f);
        ...
        lightCubeShader.setVec3("u_lightColor", lightColor);
