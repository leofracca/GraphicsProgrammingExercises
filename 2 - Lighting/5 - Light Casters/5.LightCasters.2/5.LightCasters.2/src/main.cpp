...
const std::string TITLE = "LightCasters2";
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Set the light properties (in this case we are defining a spotlight)
        lightingShader.setVec3("u_light.position", camera.GetPosition());
        lightingShader.setVec3("u_light.direction", camera.GetFront());
        lightingShader.setFloat("u_light.cutoff", glm::cos(glm::radians(12.5f)));
        lightingShader.setVec3("u_light.ambient", 0.1f, 0.1f, 0.1f);
        lightingShader.setVec3("u_light.diffuse", 0.8f, 0.8f, 0.8f);
